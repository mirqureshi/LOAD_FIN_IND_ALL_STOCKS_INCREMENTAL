...
print("Historical weekly ADX from Alpha Vantage started...", flush=True)
...
def main():
    ...
    try:
        ...
        print("=" * 70, flush=True)
        print("Historical weekly ADX from Alpha Vantage", flush=True)
        ...
        print("\n" + "=" * 70, flush=True)
        print("Finished historical weekly ADX load.", flush=True)
